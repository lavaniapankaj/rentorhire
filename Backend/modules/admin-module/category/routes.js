...
const {validateGetCategory, validateCreateCategory, validateDetailCategory, validateUpdateCategory, validateDeleteCategory, validateadminGetAllActiveCate } = require('./validation');

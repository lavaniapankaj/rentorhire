  ...
  return (
    <>
            ...
            <div className="row justify-content-center">
                ...
                <div className={`container ${styles.custom_searchbar_wrap}`}>
                    ...
                    >
                        ...
                        {/* Location */}
                        <div
                            className={`col-lg-3 col-md-6 col-12 ${styles.border_rightF1}`}
                        >
                            <div className="form-group w-100">
                            <label
                                htmlFor="location"
                                className="loc_block_inner"
                            >
                                Location
                            </label>
                        ...
                        {/* Category */}
                        <div
                            className={`col-lg-3 col-md-6 col-12 ${styles.border_rightF2}`}
                        >
                            <div className="form-group w-100">
                            <label
                                htmlFor="category"
                                className="cat_block_inner"
                            >
                                Category
                            </label>
        ...
        <div className={styles.fleetswrap_inner}>
            ...
            <div
                className={`container-fluid px-2 px-md-3 px-lg-3 position-relative mt-5 ${styles.roh_container98}`}
            >
                ...
                {!loading &&
                    ...
                    <div key={p.id} className="col-12 col-sm-6 col-lg-3">
                        <div
                        className={`card p-4 ${styles.fleetscard} h-100`}
                        >
                        <Image
                            src={
                            p?.media_gallery?.[0]
                                ? p.media_gallery[0].file_path +
                                p.media_gallery[0].file_name
                        ...
                        />
                        <div
                            className={`card-body d-flex flex-column pt-3 ${styles.cardBody}`}
                        >
                            <div>
                            ...
                            <h5
                                className={`${styles.feets_cardH} mt-3 mb-3`}
                            >
                                {p?.item_name}
                            </h5>
                            </div>

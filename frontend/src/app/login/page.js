...
export default function LoginPage() {
  ...
  const onOtpSubmit = async (e) => {
    ...
    try {
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_USER_URL}/sign-in-verify-otp`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const onResendOtp = async () => {
    ...
    try {
      ...
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_USER_URL}/verify-resendotp`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },

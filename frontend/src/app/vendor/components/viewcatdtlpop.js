      ...
      <div className={styles.roh_popup_box}>
        ...
        <div className={styles.roh_popup_body}>
          <div className="roh_vehicleSection">
            <div className="container-fluid px-2 px-md-3 px-lg-3 position-relative mt-2 mt-md-3 mt-lg-4">
                  ...
                  {showDetails && (
                    <section>
                      <div className="roh_singleVehicle_detailsInner">
                        <div className={`d-flex  gap-2 justify-content-start ${styles.roh_singleVehicle_detailsHeader}`}>
                          <button onClick={handleBackToListing} className={`border-0 bg-white p-2 ${styles.roh_backTolisting}`}>
                            <Image src="/back.svg" width={20} height={20} alt="Back to Listing" />
                          </button>
                          <h4 className="mb-0 lh-base text-center">{category} Details</h4>
                        </div>

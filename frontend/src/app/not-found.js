  ...
  return (
    ...
    <div
      ...
      <div className={`relative z-10 text-center px-6 animate-fadeIn ${styles.roh_page404Inner}`}>
        ...
        {/* Message */}
        <h2 className={`text-3xl md:text-4xl text-dark font-bold mt-4 drop-shadow ${globalStyles.roh_headingH2}`}>
          Oops! Page Not Found
        </h2>
        ...
        <div className={`d-flex align-items-center justify-content-center ${globalStyles.roh_btnsRed}`}>
                                <div className={`${globalStyles.roh_button_custom}`}><Link href="/">Back To Home</Link></div>
                                <div className={`${globalStyles.roh_circl_btn}`}>
